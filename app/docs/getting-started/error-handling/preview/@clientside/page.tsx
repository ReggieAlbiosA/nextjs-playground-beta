...
export default function ImageUploadDemo() {
  ...
  return (
    <Card className="bg-background/50">
      ...
      <CardContent>
        <div 
            className={`relative flex flex-col items-center justify-center w-full p-8 border-2 border-dashed rounded-lg transition-colors ${dragActive ? 'border-primary bg-primary/10' : 'border-border'} ${error ? 'border-destructive' : ''}`}
        ...
        >
            ...
            {previewUrl && selectedFile ? (
                <div className="text-center">
                    <img src={previewUrl} alt="Preview" className="max-h-40 mx-auto mb-4 rounded-lg"/>
